...
public class StudentPasswordChange extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			ResultSet resultset = statement.executeQuery("select password from students where password='" + cpassword
			...
			if (password.equals(confpass)) {
				if (pass.equals(cpassword)) {
					int i = statement.executeUpdate("update students set password='" + password + "' where uname='"
