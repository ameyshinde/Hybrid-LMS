...
public class AdminPasswordChange extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			ResultSet resultset = statement.executeQuery("select password from admin where password='" + cpassword
			...
			if (password.equals(confpass)) {
				if (pass.equals(cpassword)) {
					int i = statement.executeUpdate("update admin set password='" + password + "' where uname='"
