	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			ResultSet resultset = statement
					.executeQuery("select password from faculty where password='" + cpassword + "' OR password='"
			...
			if (password.equals(confpass)) {
				if (pass.equals(cpassword) || pass.equals(hashedCurrentPassword)) {
					int i = statement.executeUpdate("update faculty set password='" + hashedNewPassword + "' where uname='"
