	...
	<div class="container-fluid">
		<div class="panel panel-default shadow p-3 mb-5">
			<div class="panel-body">
				<%
				ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select COUNT(status) from projectinfo where status='PENDING'");
				resultset.next();
				...
				%>
				<div class='alert alert-success' id='success'>Project Reviewed and Updates if any
				...
				<div class="panel panel-secondary shadow p-3 mb-5">
					<div class="panel-heading bg-info text-white">
						Projects&nbsp;&nbsp;&nbsp;&nbsp;[&nbsp;<%=(new java.util.Date()).toLocaleString()%>&nbsp;]&nbsp;&nbsp;<a
