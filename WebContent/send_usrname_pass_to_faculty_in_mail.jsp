		...
		<div class="panel panel-default shadow p-3 mb-5">
			<div class="panel-body">
				<div class="alert alert-info shadow p-3 mb-5"
					style="text-transform: uppercase">Faculty Activity / Send
					User Name & Password Email to Faculty</div>
				<%
				String resultMessage = (String) session.getAttribute("mail-success");
				if (resultMessage != null) {
					session.removeAttribute("mail-success");
				%>
				<div class="alert alert-success" id="success">Faculty
					credentials user name & password send successfully via email.</div>
				<%
				}
				%>
					...
					<div class="panel-body">
						<table id="table"
							...
							<tbody>
								...
								%>
								<form action="FacultyEmailSendingServlet" method="post">
									<tr>
										<td><%=rs.getInt(1)%></td>
										...
										<td><span class="label label-info"><%=rs.getString(7)%></span></td>
										<td><a
											href="FacultyEmailSendingServlet?teacher_id=<%=rs.getInt(1)%>"
