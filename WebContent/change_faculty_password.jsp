	...
	<div class="container-fluid">
		<div class="panel panel-default shadow p-3 mb-5">
			<div class="panel-body">
				<div class="alert alert-info shadow p-3 mb-5" style="text-transform: uppercase">Change Faculty Password</div>
				<%
							...
							<div class="col-md-9">
								<div class="card">
									<div class="card-body">
										...
										<form name="ChangePasswordForm" action="FacultyPasswordChange"
											method="post" OnSubmit="return fncSubmit();">
											<%
												Connection con = DatabaseConnection.getConnection();
													Statement st = con.createStatement();
													ResultSet rs = st.executeQuery(
															"select password from faculty where uname='" + session.getAttribute("uname") + "'");
													if (rs.next()) {
											%>
											<div class="row">
												<div class="col-md-12">
