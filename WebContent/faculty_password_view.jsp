		...
		<div class="panel panel-default shadow p-3 mb-5">
			<div class="panel-body">
				<div class="alert alert-info shadow p-3 mb-5"
					...
					Students Password Generation</div>
				<%
				...
				<div class="alert alert-success" id="success">System generated
					all Faculty password successfully.</div>
				<%
				}
				%>
				<div class="panel panel shadow p-3 mb-5">
					...
					<div class="panel-body">
						<form action="facultyPasswordGen" method="post">
							<table id="table"
								...
								<tbody>
									...
									<tr>
										...
										<td><span class="label label-warning"><%=rs.getString(7)%></span></td>
									</tr>
									<%
									}
									%>
