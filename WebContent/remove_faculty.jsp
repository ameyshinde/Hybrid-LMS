	...
	<div class="container-fluid">
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="alert alert-info shadow p-3 mb-5" style="text-transform: uppercase">Faculty Activity / Remove
					Faculty Or Multiple Faculty</div>
				<%
				...
				<div class="panel panel shadow p-3 mb-5">
					<div class="panel-heading bg-light" style="text-transform: uppercase"">
						<strong>Remove Multiple Faculty &nbsp;[&nbsp;<%=(new java.util.Date()).toLocaleString()%>&nbsp;]&nbsp;&nbsp;</strong>
					</div>
					<div class="panel-body">
						<form action="FacultyRemoval" method="post">
							<input type="submit" value="Delete Faculty / Multiple Faculty"
