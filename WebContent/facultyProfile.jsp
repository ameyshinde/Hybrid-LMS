		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="alert alert-info shadow p-3 mb-5"
					style="text-transform: uppercase">Student Profile</div>
								...
								<div class="card">
									<div class="card-body">
										<div class="row">
											...
											ResultSet rs = st.executeQuery("select * from faculty where uname='" + session.getAttribute("uname") + "'");
											if (rs.next()) {
											%>
											<div class="col-md-12">
												<h4>My Profile</h4>
										...
										<div class="row">
											<div class="col-md-12">
												<form>
													...
													<div class="form-group row">
														<label for="collegename" class="col-4 col-form-label">Branch
															Name</label>
														<div class="col-8">
