		...
		<div class="panel panel-default shadow p-3 mb-5">
			<div class="panel-body">
				<div class="alert alert-info shadow p-3 mb-5"
					style="text-transform: uppercase">Take Students Attendance</div>
				<%
				...
				<div class="panel panel shadow p-3 mb-5">
					<div class="panel-heading bg-light"
						...
						<a class="btn btn-success"><span class="badge"><%=count%></span>
							Active Students</a> &emsp;&emsp;&emsp;<input type="button"
							value="Select All Present" id="select-all-present">
