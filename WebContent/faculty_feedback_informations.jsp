...
<body style="background-color:#F0F0F0";>
	...
	%>
	<%
		ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select count(*) from faculty_feedback");
			resultset.next();
			...
			<div class="panel-body">
				...
				<div class="panel panel shadow p-3 mb-5">
					<div class="panel-heading bg-light" style="text-transform: uppercase;font-size:small;font-weight: bold;">
						Faculty Feedback &nbsp;[&nbsp;<%=(new java.util.Date()).toLocaleString()%>&nbsp;]&nbsp;&nbsp;&nbsp;&nbsp;<a
								...
								<tbody>
									<%
										Connection con = DatabaseConnection.getConnection();
											...
											ResultSet rs = st.executeQuery("Select * from faculty_feedback");
											while (rs.next()) {
									%>
									<tr>
										<td><%=rs.getInt(1)%></td>
