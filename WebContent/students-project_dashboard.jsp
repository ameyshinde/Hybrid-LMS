									...
									<div class="card-body">
										...
										<div class="row">
											<div class="col-md-12">
												<h2 align="center">
													<%
													out.println("Name : " + session.getAttribute("uname").toString().toUpperCase());
													%>
												</h2>
												<h3 align="center">
													<%
													out.println("Student ID : " + session.getAttribute("student_id").toString().toUpperCase());
													%>
												</h3>

												<div class="container">

													<a href="add_project_details.jsp">
														<button class="btn btn-warning"
															style="margin-left: 130px;">Add New Project</button>
													</a> <a href="showmyprojects">
														<button class="btn btn-warning"
															style="margin-left: 130px;">Show My Projects</button>
													</a> <a href="searchproject.html">
														<button class="btn btn-warning"
															style="margin-left: 130px;">Search Project</button>
													</a>
												</div>
											</div>
										</div>
