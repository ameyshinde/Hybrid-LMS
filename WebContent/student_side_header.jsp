...
<nav
	...
	<img src="images/newlogo.png" width="200px" height="50px" /> <a
		class="navbar-brand" href="after_studentLogin.jsp"><span
	...
	<ul class="navbar-nav">
		...
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			...
			<div class="dropdown-menu">
				<a class="dropdown-item" href="apply_for_leave.jsp">Apply For
					Leave</a> <a class="dropdown-item" href="leave_status_report.jsp">Leave
					Status Report</a>
			</div></li>
		<li class="nav-item"><a class="nav-link"
