		...
		<div class="panel panel-default shadow p-3 mb-5">
			<div class="panel-body">
				<div class="alert alert-info shadow p-3 mb-5"
					style="text-transform: uppercase">Today's Attendance Report</div>
							...
							<table id="table"
								...
								<tbody>
									...
									ResultSet rs = st.executeQuery(
											"select * from students natural join student_attendance where status=1 and system_date=CURDATE() and subject='"
											+ subject + "'");
									while (rs.next()) {
										int id = rs.getInt(1);
									%>
									...
									<tr>
										...
										ResultSet presentResultset = DatabaseConnection.getResultFromSqlQuery(
												"select count(*) from student_attendance where attendance='present' and system_date=CURDATE() and subject='"
												+ subject + "'");
										...
										ResultSet absentResultset = DatabaseConnection.getResultFromSqlQuery(
												"select count(*) from student_attendance where attendance='absent' and system_date=CURDATE() and subject='"
												+ subject + "'");
