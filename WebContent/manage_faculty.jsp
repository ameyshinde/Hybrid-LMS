...
<body style="background-color:#F0F0F0";>
	...
	%>
	<%
			ResultSet resultset = DatabaseConnection.getResultFromSqlQuery("select count(*) from faculty where status=1");
			resultset.next();
							...
							<tbody>
								...
								<tr>
									...
									<%
										if (rs.getInt(8) == 1) {
									%>
									<td><a href="ManageFaculty?id=<%=rs.getInt(1)%>"><button
